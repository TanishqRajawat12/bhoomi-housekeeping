...
const featuredServices = [
  {
    title: "Sofa Cleaning",
    description: "Bring your sofa back to life — we remove deep-set stains, odours, and allergens leaving it fresh, sanitised, and looking brand new.",
    icon: "sofa",
  ...
  },
  {
    ...
    description: "Stubborn stains and trapped dirt removed for good. Our hot-water extraction leaves carpets deeply clean, dry faster, and smelling fresh.",
    icon: "carpet",
  ...
  {
    title: "Pest Control",
    description: "Reclaim your home from unwanted guests. Our targeted treatments eliminate pests at the source — safe for your family and pets.",
    icon: "pest",
  ...
  },
  {
    ...
    description: "Dull, scratched marble restored to a mirror-like shine. We buff away years of wear and seal the surface to protect it long-term.",
    icon: "marble",
